...
class SourceAdmin(TranslatableAdmin):
    list_display = ("display_title", "organisation", "source_type", "language", "status", "publication_date")
    ...
    fieldsets = (
        ...
        (_("Publication data"), {"fields": ("publication_date", "url", "localized_url", "bibliographic_reference")}),
        (_("Editorial data"), {"fields": ("summary",)}),
...
class CitationAdmin(admin.ModelAdmin):
    list_display = ("source", "content_label", "language", "order", "locator", "created_at")
    list_filter = ("language", "content_type")
    search_fields = ("source__title", "note", "locator")
    autocomplete_fields = ("source",)
    readonly_fields = ("created_at",)
    fields = ("source", "content_type", "object_id", "language", "order", "locator", "note", "created_at")
